...
import CaptainFinishRide from '../components/captainComponents/CaptainFinishRide'

const CaptainRidingShowingDirections = () => {
    ...
    <div>
          <div className='h-screen relative'>
              ...
              <div className='h-1/5 p-6 flex items-center justify-between relative bg-yellow-400 pt-10'>
                  ...
                  <button className=' bg-green-600 text-white font-semibold p-3 px-10 rounded-lg' onClick={()=>{
...
export default CaptainRidingShowingDirections