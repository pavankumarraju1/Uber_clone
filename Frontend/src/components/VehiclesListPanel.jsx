...
const VehiclesListPanel = (props) => {
  return (
    <div>
          <h5 className='p-1 text-center absolute top-0 left-[50%]' onClick={()=>{
          ...
          <div className='flex border-2 active:border-black mb-3 rounded-xl w-full p-3  items-center justify-between' onClick={() => {
              props.setconfirmVehiclePanel(true)
          }}>
